...
public class ClassDao {
	...
	public ClassInfo getClassByClassId(BigInteger classId) throws ClassesNotFoundException {
		ClassInfo classInfo=classMapper.getClassByClassId(classId);
		if(classInfo==null) {
			throw new ClassesNotFoundException("无此classId的班级");
		}
		return classInfo;
	}

	
	public int updateClassByClassId(BigInteger classId, ClassInfo newClass){
		int update=0;
		ClassInfo classInfo=classMapper.getClassByClassId(classId);
	...
	public int deleteClassByClassId(BigInteger classId) {
		int delete=0;
		ClassInfo classInfo=classMapper.getClassByClassId(classId);
		classMapper.deleteLocationByClassId(classId);
	...
	public int deleteScoreRuleById(BigInteger classId) throws ClassesNotFoundException {
		int delete=0;
		ClassInfo classInfo=classMapper.getClassByClassId(classId);
		if(classInfo==null) {
			throw new ClassesNotFoundException("无此classId的班级");
	...
	public BigInteger callInRollById(Location location) throws SeminarNotFoundException{
	...
	public int endCallRollById(BigInteger seminarId, BigInteger classId) throws SeminarNotFoundException, ClassesNotFoundException {
		int update=0;
		Seminar seminar=classMapper.selectSeminarBySeminarId(seminarId);
		if(seminar==null) {
			throw new SeminarNotFoundException("无此seminarId的讨论课");
	...
	public List<ClassInfo> listClassByUserId(BigInteger userId)
		...
		if(!(userId instanceof BigInteger)) {
			...
			if(classIds.isEmpty()) {
				throw new ClassesNotFoundException("找不到班级");
			}else {
