...
public class AuthController {
    ...
    public ResponseEntity weChatLogin(@RequestParam String code,@RequestParam Integer type) throws IOException{
        try{
            Map<String, Object> ne = authService.weChatLogin(code, type);
